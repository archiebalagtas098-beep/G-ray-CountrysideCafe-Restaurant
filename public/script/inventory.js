...
const menuItemIngredients = {
    ...
    'Buffalo Chicken Wings (S)': ['Chicken Wings', 'Flour', 'Cornstarch', 'Butter', 'Garlic', 'Cooking Oil', 'Salt', 'Black Pepper', 'Plates', 'Napkins', 'Plastic Utensils Set'],
    'Buffalo Chicken Wings (M)': ['Chicken Wings', 'Flour', 'Cornstarch', 'Butter', 'Garlic', 'Cooking Oil', 'Salt', 'Black Pepper', 'Plates', 'Napkins', 'Plastic Utensils Set'],
    'Buffalo Chicken Wings (L)': ['Chicken Wings', 'Flour', 'Cornstarch', 'Butter', 'Garlic', 'Cooking Oil', 'Salt', 'Black Pepper', 'Plates', 'Napkins', 'Plastic Utensils Set'],
